...
const app = require('../index.js'); // Ensure you import your Express app here

describe('/searchMovies endpoint', () => {

  it('should return movies that match the given film name', async () => {
    const response = await request(app).get('/searchMovies').query({
      filmName: 'ExampleFilmName' // Replace with a film name in your database for testing
    });
